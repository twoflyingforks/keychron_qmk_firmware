...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_69_ansi(
        ...
        KC_ESC ,  KC_A,	   KC_R,	 KC_S,	  KC_T,       KC_G,        KC_M,     KC_N,	KC_E,	 KC_I,	   KC_O,  KC_MINS,  XXXXXXX,           KC_PGDN,
        KC_TAB ,  KC_Z,	   KC_X,	 KC_C,    KC_D,	      KC_V,	       KC_V,     KC_K,	KC_H,	 KC_COMM,  KC_DOT,	 KC_SLSH,  KC_QUOT, KC_UP,
